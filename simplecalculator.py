...
if __name__ == "__main__":
    ...
    gui.configure(background="grey")                 # set the background colour of GUI window


    gui.title("Simple Calculator")                          # set the title of GUI window

    gui.geometry("400x400")                                 # set the configuration of GUI window
    ...
    plus = Button(gui, text=' + ', fg='black', bg='white',command=lambda: press("+"), height=2, width=7)
